  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-rose-50 to-pink-100 py-20 px-4">
      <div className="max-w-3xl">
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border-4 border-red-200">
          <div className="flex items-center justify-center mb-8">
            <Sparkles className="w-8 h-8 text-red-500 mr-2" />
            <h2 className="text-2xl font-bold text-red-600">Стихи для тебя</h2>
            <Sparkles className="w-8 h-8 text-red-500 ml-2" />
          </div>
          
          <div className="space-y-8 text-gray-700">
            
            <div className="text-left text-l leading-relaxed">
